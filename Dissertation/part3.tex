...
\begin{table}[h]
	...
	\begin{tabular}{| p{7cm} | p{10cm} |}
		...
		\hline
		\textbf{Functions}                                    & \textbf{Explanation}                                                                                                                \\ \hline
		sequence\_for\_train                             & load preprocessed tokens from previous model and use functions listed below to create sequence of indices which corresponds to particular word.                                                                    
		\\ \hline
