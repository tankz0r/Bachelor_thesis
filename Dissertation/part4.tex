...
\newpage
\thispagestyle{empty}
\mbox{}processed/train.csv
%5.1 Постановка задачі техніко-економічного аналізу	69
%5.1.1 Обґрунтування функцій програмного продукту	70
%5.1.2 Варіанти реалізації основних функцій	71
...
%5.3 Аналіз рівня якості варіантів реалізації функцій	80
%5.4 Економічний аналіз варіантів розробки ПП	81
%5.5 Вибір кращого варіанта ПП техніко-економічного рівня	86
