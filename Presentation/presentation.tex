...
%		\vspace{20pt}%
	...
	\begin{document}
		...
		\begin{frame}
			...
			\begin{tabular}{cl}  
				\begin{tabular}{l}
					\includegraphics[height=3.5cm, width=5cm]{part4/final_CNN_train_category_accuracy}
					\includegraphics[height=3.5cm, width=5cm]{part4/final_CNN_val_category_accuracy}
				\end{tabular}
				& \begin{tabular}{l}
					\includegraphics[height=3.5cm, width=5cm]{part4/final_CNN_val_category_crossentropy}
				\end{tabular}  \\
			\end{tabular}
		\end{frame}
